...
\begin{table}[H]
	\begin{tabularx}{\textwidth}{l|Xlllr}
		...
		\textbf{Tipo}          & Primario & & & \\
		\textbf{Referencias}   & \multicolumn{5}{>{\hsize=\dimexpr\textwidth-\hsize\relax}X}{RF-29, RN-1}\\
		\textbf{Precondición}  & \multicolumn{5}{>{\hsize=\dimexpr\textwidth-0.85\hsize\relax}X}{Plataforma activa y operativa, sanitario dado de alto como tal y sanitario asociado a la consulta}\\ 
